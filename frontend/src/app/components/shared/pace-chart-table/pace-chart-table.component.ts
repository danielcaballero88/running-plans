...
@Component({
  selector: 'app-pace-chart-table',
  templateUrl: './pace-chart-table.component.html',
  styleUrls: ['./pace-chart-table.component.scss'],
})
export class PaceChartTableComponent implements OnInit {
